...
import { Container, GridColumn, Header, Image, Segment, Grid } from 'semantic-ui-react';
      ...
      return (
        <div>
          ...
          <Segment.Group style={{ backgroundColor: 'black'}}>
            <Segment inverted  textAlign='right' size='massive' as='h5' style={{ backgroundColor: 'black'}}>Who Am I?</Segment>
            <Segment.Group style={{ backgroundColor: 'black'}}>
              <Segment inverted textAlign='center' size='huge' as='h1' style={{ backgroundColor: 'black'}}>Recent Graduate</Segment>
              <Segment.Group>
                <Segment inverted style={{ backgroundColor: 'black'}}>
                The Fall of 2020 I graduated from the University of Florida with a Bachelor’s in Computer Science 
                and a Minor in Innovation. My minor in innovation lead me to take on classes that were focused on 
            ...
            <Segment inverted  textAlign='right' size='massive' as='h5' style={{ backgroundColor: 'black'}}>What Have I Done?</Segment>
            <Segment.Group style={{ backgroundColor: 'black'}}>
              <Segment inverted textAlign='center' size='huge' as='h1' style={{ backgroundColor: 'black'}}>Projects and Experience</Segment>
              <Segment.Group>
                <Segment inverted style={{ backgroundColor: 'black'}}>
                  <Grid columns={3} divided>
                    <Grid.Row>
                      <Grid.Column>
                        <Header as='h3' inverted>A Student</Header>
                      ...
                      <Grid.Column>
                        <Header as='h3' inverted>An Intern</Header>
                      ...
                      <Grid.Column>
                        <Header as='h3' inverted>An Assistant</Header>
            ...
            <Segment inverted  textAlign='right' size='massive' as='h5' style={{ backgroundColor: 'black'}}>Why Choose Me?</Segment>
            <Segment.Group style={{ backgroundColor: 'black'}}>
              <Segment inverted textAlign='center' size='huge' as='h1' style={{ backgroundColor: 'black'}}>A Drive to Succeed</Segment>
              <Segment.Group>
                <Segment inverted style={{ backgroundColor: 'black'}}>
